...
const TEMPLATES: Record<TemplateType, { name: string, icon: any, parts: any[], blueprint: BlueprintPart[], bg: string, prompt: string }> = {
  house: {
    ...
    blueprint: [
      { x: 72, y: 38, w: 30, h: 50, renderType: 'rect' }, 
      { x: 50, y: 70, w: 150, h: 120, renderType: 'rect' }, 
      { x: 50, y: 40, w: 190, h: 100, renderType: 'triangle' }, 
      { x: 40, y: 80, w: 45, h: 70, renderType: 'door' }, 
      { x: 65, y: 65, w: 45, h: 45, renderType: 'window' }, 
    ]
  },
  snowman: {
  ...
  clown: {
    ...
    blueprint: [
      { x: 50, y: 60, w: 150, h: 150, renderType: 'circle' }, 
      { x: 40, y: 55, w: 24, h: 24, renderType: 'eye' },      
      { x: 60, y: 55, w: 24, h: 24, renderType: 'eye' },      
      { x: 50, y: 65, w: 35, h: 35, renderType: 'circle' },  
      { x: 50, y: 32, w: 120, h: 130, renderType: 'triangle' }, 
      { x: 50, y: 18, w: 30, h: 30, renderType: 'pom-pom' }, 
    ]
  },
  car: {
    name: 'Cochito',
